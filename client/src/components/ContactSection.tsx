...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-16 bg-primary-light">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-12">
          <div className="md:w-1/2">
            <h2 className="text-3xl font-bold mb-4">Get in touch</h2>
            <p className="text-gray-600 mb-6">Have questions or need support? We're here to help.</p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@turtlechat.com" className="text-primary hover:underline">support@turtlechat.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Language Lane</p>
