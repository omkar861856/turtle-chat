      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-600 mb-4">Learn languages the natural way with AI-powered conversations.</p>
            <div className="space-y-2">
              <p className="text-gray-600">© 2023 TurtleChat</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Languages</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Mobile App</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Web App</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 mb-4 md:mb-0">© 2023 TurtleChat Technologies, Inc. All rights reserved.</p>
